  ...
  return (
    <div className="animate-in fade-in duration-700 space-y-12 pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10">
        ...
        <div className="col-span-1 lg:col-span-3 flex flex-row lg:flex-col overflow-x-auto no-scrollbar gap-2 lg:gap-2 pb-4 lg:pb-0">
          <button className="flex-1 lg:w-full text-nowrap lg:text-left px-6 py-4 rounded-2xl bg-primary/10 text-primary font-black text-[10px] uppercase tracking-widest border border-primary/20 shadow-inner">
            Hospital Identity
          </button>
          <button className="flex-1 lg:w-full text-nowrap lg:text-left px-6 py-4 rounded-2xl text-on-surface-variant hover:bg-surface-container hover:text-on-surface transition-all font-black text-[10px] uppercase tracking-widest border border-transparent hover:border-outline-variant/10">
            Security & Access
          </button>
          <button className="flex-1 lg:w-full text-nowrap lg:text-left px-6 py-4 rounded-2xl text-on-surface-variant hover:bg-surface-container hover:text-on-surface transition-all font-black text-[10px] uppercase tracking-widest border border-transparent hover:border-outline-variant/10">
            Operational Rules
          ...
          <button className="lg:w-full text-nowrap lg:text-left px-6 py-4 rounded-2xl text-error/60 hover:bg-error/10 hover:text-error transition-all font-black text-[10px] uppercase tracking-widest border border-transparent hover:border-error/20 lg:mt-10">
            Factory Reset
          </button>
        </div>
        ...
        <div className="col-span-12 lg:col-span-9 space-y-8">
          ...
          <div className="bg-surface-container rounded-[2.5rem] p-6 md:p-10 border border-outline-variant/5 shadow-2xl space-y-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              <div className="sm:col-span-2 flex flex-col sm:flex-row items-center gap-6 md:gap-8 p-6 md:p-8 bg-surface-container-low rounded-3xl border border-outline-variant/10">
                <div className="w-20 h-20 md:w-24 md:h-24 bg-primary-container rounded-3xl flex items-center justify-center border-4 border-surface shadow-xl flex-shrink-0">
          ...
          <div className="bg-surface-container rounded-[2.5rem] p-10 border border-outline-variant/5 shadow-2xl">
            <h4 className="text-2xl font-black text-on-surface tracking-tight mb-8">Operational Parameters</h4>
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={idx} className="flex justify-between items-center p-6 bg-surface-container-low rounded-2xl border border-outline-variant/5 hover:border-outline-variant/20 transition-all">
                  <div>
          ...
          {/* Danger Zone */}
          <div className="bg-error/5 rounded-[2.5rem] p-6 md:p-10 border border-error/10">
